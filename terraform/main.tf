...
# Google Cloud Function v2 - Hello World
# Demonstrates basic HTTP and CloudEvent handling patterns
# Serves as a template for other functions in the project
resource "google_cloudfunctions2_function" "hello_world" {
  name        = "hello-world"
  description = "Demo function supporting both HTTP requests and CloudEvent triggers"
  location    = var.region
...
# IAM policy for hello-world function - allows public invocation
# WARNING: This grants public access to the function
# Modify the 'member' field to restrict access as needed
...
# Hello World function source code archive
# Contains the built and zipped hello world function
# Generated by npm run build:function command
